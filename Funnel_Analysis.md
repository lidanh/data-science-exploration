...
In this report we will analyze the funnel of a SaaS product which enables the users to send payment requests to their users, and get paid online and offline. We won't publish the product or the company due to confidentiality reasons.
